...
<html lang="en-US">
   ...
   <body class="size-1140">
      <header>
                  ...
                  <ul class="right">
                     ...
                     <li class='has-sub'><a href='tentang.php'><span>Tentang</span></a>
                        <ul>
                          ...
                          <li class='has-sub'><a href='#section-three'><span>Kompetensi</span></a>
                             <ul>
                                <li><a href='#a'><span>Kompetensi Unggulan</span></a></li>
                                <li class='last'><a href='#a'><span>Kompetensi Tambahan</span></a></li>
                             </ul>
                          </li>
                          <li><a href='#section-four'><span>Akreditasi</span></a></li>
                          <li><a href='#section-five'><span>Mitra</span></a></li>
                        </ul>
                      </li>
         ...
         <div id="section-menu" style="background-color: transparent;">
          <ul>
          </ul>
         </div>
      </header>  
         <div id="latest-news">
            <div class="line">
              <h2 class="section-title" style="padding-top: 10px;">List Dosen</h2> 
              <div class="margin">
                  
                 <section id="section-one" class="section scroll-item" title="List Dosen">
                 <div class="inner">
                   <table>
                     <thead style="background-color: #005577; color: #fff;">
                       <td>NIK</td>
                       <td>Nama</td>
                       <td>Jabatan</td>
                       <td>Email</td>
                     ...
                     <tbody>
                        <tr>
                          <td>000000xxxxx</td>
                          <td> Farica Perdana Putri, S.Kom., M.Sc</td>
                          <td>test</td>
                          <td>farica@umn.ac.id</td>
                        </tr>
                     </tbody>
                   </table>
                 </div>
         ...
         <div id="services">
            <div class="line">
               ...
               <div class="margin">
                <section id="section-two" class="section scroll-item" title="Detail Dosen">
